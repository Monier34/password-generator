...
lenght_entry = Entry(width=10, justify=CENTER)
number_entry.insert(0, "8")
lenght_entry.insert(0, "25")

number_lable = Label(text="      Количество паролей")
lenght_lable = Label(text="      Длина пароля")
number_lable.grid(row=0, column=0, sticky="w")
lenght_lable.grid(row=1, column=0, sticky="w")
number_entry.grid(row=0, column=1, padx=1, pady=5)
lenght_entry.grid(row=1, column=1, padx=1, pady=5)
